# -*- coding: utf-8 -*-
"""
Creates, distributes and gathers results of parallel calculation.
...
class MPMaster(Process):
    """A prototype class for parallel processing.
    """
    ...
    def __init__(self, kill_workers, profiling=False):
        ...
        | Params:
        |    n_wrk      -- number of workers to detect when all of them 
                           are finished
    ...
    def get_new_task(self):
        """Shoud **yield** tasks. Not implemented.
        """
        raise NotImplementedError


    def process_result(self, result, flush):
        """Processes the result - saves to database, etc. Not implemented.
        """
        raise NotImplementedError
